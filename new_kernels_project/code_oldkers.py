...
from plotter import compute_logY0
...
e1,e2,e3,e4,e5=TBA_loop(r,A*(r**(1/5)),rapidityMax,rapidityMin,numPoints)
Y0=compute_logY0(e1,e2,e3,e4,e5)
c=compute_central_charge(0.0000000001, A*(r**(1/5)), rapidityvals, e1,e2,e3,e4,e5, step)
print(c)
print(Y0[len(Y0)//2])